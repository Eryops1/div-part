...
#mydata <- read.csv("//INSERTPATH/Ordovician-vetted.csv", row.names = NULL, sep=",")

#from web
mydata <- read.csv(url("https://raw.githubusercontent.com/fossilrich/div-part/master/Ordovician-vetted.csv"), row.names = NULL, sep=";")
...
OrdDat <- cbind(Age, AlphaForm, BetaWForm, BetaSForm, BetaJForm, GammaForm, CollpF, 
