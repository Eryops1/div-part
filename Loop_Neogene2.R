...
#mydata <- read.csv("//INSERTPATH/Neogene2-vetted.csv", row.names = NULL, sep=",")

#from web
mydata <- read.csv(url("https://raw.githubusercontent.com/fossilrich/div-part/master/Neogene2-vetted.csv"), row.names = NULL, sep=";")
...
Neog2Dat <- cbind(Age, AlphaForm, BetaWForm, BetaSForm, BetaJForm, GammaForm, CollpF, 
