...
#mydata <- read.csv("//INSERTPATH/Cretaceous2-vetted.csv", row.names = NULL, sep=",")

#from web
mydata <- read.csv(url("https://raw.githubusercontent.com/fossilrich/div-part/master/Cretaceous2-vetted.csv"), row.names = NULL, sep=";")
...
Creta2Dat <- cbind(Age, AlphaForm, BetaWForm, BetaSForm, BetaJForm, GammaForm, CollpF, 
