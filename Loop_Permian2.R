...
#mydata <- read.csv("//INSERTPATH/Permian2-vetted.csv", row.names = NULL, sep=",")

#from web
mydata <- read.csv(url("https://raw.githubusercontent.com/fossilrich/div-part/master/Permian2-vetted.csv"), row.names = NULL, sep=";")
...
Perm2Dat <- cbind(Age, AlphaForm, BetaWForm, BetaSForm, BetaJForm, GammaForm, CollpF, 
