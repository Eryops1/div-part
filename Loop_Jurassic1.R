...
#mydata <- read.csv("//INSERTPATH/Jurassic1-vetted.csv", row.names = NULL, sep=",")

#from web
mydata <- read.csv(url("https://raw.githubusercontent.com/fossilrich/div-part/master/Jurassic1-vetted.csv"), row.names = NULL, sep=";")
...
Jura1Dat <- cbind(Age, AlphaForm, BetaWForm, BetaSForm, BetaJForm, GammaForm, CollpF, 
