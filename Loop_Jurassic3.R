...
#mydata <- read.csv("//INSERTPATH/Jurassic3-vetted.csv", row.names = NULL, sep=",")

#from web
mydata <- read.csv(url("https://raw.githubusercontent.com/fossilrich/div-part/master/Jurassic3-vetted.csv"), row.names = NULL, sep=";")
...
Jura3Dat <- cbind(Age, AlphaForm, BetaWForm, BetaSForm, BetaJForm, GammaForm, CollpF, 
