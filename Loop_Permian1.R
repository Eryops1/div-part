...
#mydata <- read.csv("//INSERTPATH/Permian1-vetted.csv", row.names = NULL, sep=",")

#from web
mydata <- read.csv(url("https://raw.githubusercontent.com/fossilrich/div-part/master/Permian1-vetted.csv"), row.names = NULL, sep=";")
...
Perm1Dat <- cbind(Age, AlphaForm, BetaWForm, BetaSForm, BetaJForm, GammaForm, CollpF, 
