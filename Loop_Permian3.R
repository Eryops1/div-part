...
#mydata <- read.csv("//INSERTPATH/Permian3-vetted.csv", row.names = NULL, sep=",")

#from web
mydata <- read.csv(url("https://raw.githubusercontent.com/fossilrich/div-part/master/Permian3-vetted.csv"), row.names = NULL, sep=";")
...
Perm3Dat <- cbind(Age, AlphaForm, BetaWForm, BetaSForm, BetaJForm, GammaForm, CollpF, 
