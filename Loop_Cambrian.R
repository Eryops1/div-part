...
#mydata <- read.csv("//INSERTPATH/Cambrian-vetted.csv", row.names = NULL, sep=",")

#from web
mydata <- read.csv(url("https://raw.githubusercontent.com/fossilrich/div-part/master/Cambrian-vetted.csv"), row.names = NULL, sep=";")
...
CamDat <- cbind(Age, AlphaForm, BetaWForm, BetaSForm, BetaJForm, GammaForm, CollpF, 
