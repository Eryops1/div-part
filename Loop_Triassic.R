...
#mydata <- read.csv("//INSERTPATH/Triassic-vetted.csv", row.names = NULL, sep=",")

#from web
mydata <- read.csv(url("https://raw.githubusercontent.com/fossilrich/div-part/master/Triassic-vetted.csv"), row.names = NULL, sep=";")
...
TriasDat <- cbind(Age, AlphaForm, BetaWForm, BetaSForm, BetaJForm, GammaForm, CollpF, 
