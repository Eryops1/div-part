...
#mydata <- read.csv("//INSERTPATH/Neogene1-vetted.csv", row.names = NULL, sep=",")

#from web
mydata <- read.csv(url("https://raw.githubusercontent.com/fossilrich/div-part/master/Neogene1-vetted.csv"), row.names = NULL, sep=";")
...
Neog1Dat <- cbind(Age, AlphaForm, BetaWForm, BetaSForm, BetaJForm, GammaForm, CollpF, 
