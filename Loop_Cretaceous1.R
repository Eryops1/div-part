...
#mydata <- read.csv("//INSERTPATH/Cretaceous1-vetted.csv", row.names = NULL, sep=",")

#from web
mydata <- read.csv(url("https://raw.githubusercontent.com/fossilrich/div-part/master/Cretaceous1-vetted.csv"), row.names = NULL, sep=";")
...
Creta1Dat <- cbind(Age, AlphaForm, BetaWForm, BetaSForm, BetaJForm, GammaForm, CollpF, 
