...
#mydata <- read.csv("//INSERTPATH/Jurassic2-vetted.csv", row.names = NULL, sep=",")

#from web
mydata <- read.csv(url("https://raw.githubusercontent.com/fossilrich/div-part/master/Jurassic2-vetted.csv"), row.names = NULL, sep=";")
...
Jura2Dat <- cbind(Age, AlphaForm, BetaWForm, BetaSForm, BetaJForm, GammaForm, CollpF, 
